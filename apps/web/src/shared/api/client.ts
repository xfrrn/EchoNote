...
export type TranscriptionProfile = Schemas['TranscriptionProfile']
...
export const api = {
  ...
  createTranscription: (episodeId: string, profile: TranscriptionProfile) => request<TranscriptionRun>(`/api/v1/episodes/${encoded(episodeId)}/transcriptions`, { method: 'POST', body: { profile } }),
